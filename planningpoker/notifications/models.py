...
class Notification(UUIDModel, TimeStampedModel):
    ...
    sender = models.ForeignKey(settings.AUTH_USER_MODEL, to_field="id", on_delete=models.SET_NULL, blank=True, null=True)
    user = models.ForeignKey(settings.AUTH_USER_MODEL, to_field="id", related_name="notifications", on_delete=models.CASCADE)
