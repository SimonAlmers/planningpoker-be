...
class FirebaseVote():
    ...
    def get_vote_ref(self, vote):
        DB_REF = db.reference(f"projects/{vote.story.project.id}/stories/{vote.story.id}/votes", app=self.app)
...
class FirebasePlanningSessionParticipant():
    ...
    def get_participant_ref(self, participant):
        DB_REF = db.reference(f"projects/{participant.session.project.id}/sessions", app=self.app)
...
class FirebasePlanningSessionComment():
    ...
    def get_comment_ref(self, comment):
        DB_REF = db.reference(f"projects/{comment.session.project.id}/sessions/{comment.session.id}/comments", app=self.app)
